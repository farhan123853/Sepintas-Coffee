    ...
    <header class="bg-gradient-to-r from-[#4E342E] via-[#2E1E1A] to-black shadow-md">
        <div class="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <nav class="space-x-6 font-medium text-white">
                ...
                <a href="register_customer.php" class="hover:text-yellow-400 transition-all duration-200">
                ...
                <!-- Tombol Logout -->
                <a href="logout_customer.php" class="hover:text-yellow-400 transition-all duration-200">
