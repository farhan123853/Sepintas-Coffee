...
<head>
    ...
    <title>Detail Produk - Caramel</title>
...
<body class="bg-gray-900 text-white min-h-screen flex flex-col">
    <div class="container mx-auto px-4 py-10 flex-1">
        ...
        <div class="bg-white rounded-lg shadow-lg p-8 flex flex-col md:flex-row items-center">
            <img src="https://raw.githubusercontent.com/farhan123853/assets/refs/heads/main/ice%20%20caramel.jpg" alt="Caramel" class="w-full md:w-1/3 h-64 object-cover rounded mb-6 md:mb-0 md:mr-8">
            <div class="flex-1">
                <h1 class="text-3xl font-bold text-amber-700 mb-4">Caramel</h1>
                <p class="text-gray-800 mb-4">Minuman kopi dengan rasa karamel yang manis dan creamy, cocok untuk penikmat kopi kekinian.</p>
